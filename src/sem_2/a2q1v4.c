...
void findmin3(tree head){
    ...
    if(head->hasPhone==3){
        if(head->left!=NULL){
            findmin3(head->left->left);
            findmin3(head->left->right);
        }
        if (head->right!=NULL){
            findmin3(head->right->left);
            findmin3(head->right->right);
        }
        return;
    }
    if(head->right==NULL && head->left==NULL && check_neighbor(head->parent)!=3){
        head->hasPhone=3;
        countmin++;
        return;
    }
    if(head->right!=NULL && head->right->right==NULL && head->right->left==NULL && head->left!=NULL && head->left->left==NULL && head->left->right==NULL && check_neighbor(head->parent)!=3){
        head->hasPhone=3;
        countmin++;
        return;
    }
    if(check_neighbor(head->parent->parent)!=3 && check_neighbor(head->parent)!=3 && check_neighbor(head->left)!=3 && check_neighbor(head->right)!=3){
        head->hasPhone=3;
        countmin++;
        if(head->left!=NULL){
            findmin3(head->left->left);
...
void findmin4(tree head){
    ...
    if(head->hasPhone==4){
        if(head->left!=NULL){
            findmin4(head->left->left);
            findmin4(head->left->right);
        }
        if (head->right!=NULL){
            findmin4(head->right->left);
            findmin4(head->right->right);
        }
        return;
    }
    if(head->right==NULL && head->left==NULL && check_neighbor(head->parent)!=4){
        head->hasPhone=4;
        countmin++;
        return;
    }
    if(head->right!=NULL && head->right->right==NULL && head->right->left==NULL && head->left!=NULL && head->left->left==NULL && head->left->right==NULL && check_neighbor(head->parent)!=4){
        head->hasPhone=4;
        countmin++;
        return;
    }
    if(check_neighbor(head->parent->parent)!=4 && check_neighbor(head->parent)!=4 && check_neighbor(head->left)!=4 && check_neighbor(head->right)!=4){
        head->hasPhone=4;
        countmin++;
        if(head->left!=NULL){
            findmin4(head->left->left);
...
void findmin5(tree head){
    ...
    if(head->hasPhone==5){
        if(head->left!=NULL){
            findmin5(head->left->left);
            findmin5(head->left->right);
        }
        if (head->right!=NULL){
            findmin5(head->right->left);
            findmin5(head->right->right);
        }
        return;
    }
    if(head->right==NULL && head->left==NULL && check_neighbor(head->parent)!=5){
        head->hasPhone=5;
        countmin++;
        return;
    }
    if(head->right!=NULL && head->right->right==NULL && head->right->left==NULL && head->left!=NULL && head->left->left==NULL && head->left->right==NULL && check_neighbor(head->parent)!=5){
        head->hasPhone=5;
        countmin++;
        return;
    }
    if(check_neighbor(head->parent->parent)!=5 && check_neighbor(head->parent)!=5 && check_neighbor(head->left)!=5 && check_neighbor(head->right)!=5){
        head->hasPhone=5;
        countmin++;
        if(head->left!=NULL){
            findmin5(head->left->left);
